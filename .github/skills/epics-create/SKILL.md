---
name: epics-create
description: 'Break requirements into epics and user stories from PRD, Architecture, and UX documents. Use when: creating epics, writing user stories, breaking down requirements into stories, creating epics from PRD.'
...
Read fully and follow: [step-01-validate-prerequisites.md](./references/step-01-validate-prerequisites.md)
