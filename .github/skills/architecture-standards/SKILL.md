...
description: 'BMAD Architecture methodology, quality standards, and reference data for creating architecture decision documents. Use when: working with architecture documents, checking architecture quality standards, understanding architecture methodology.'
---
...
- [project-types.csv](./references/project-types.csv) - Project type detection signals and typical starters
- [domain-complexity.csv](./references/domain-complexity.csv) - Domain complexity levels and suggested workflows
