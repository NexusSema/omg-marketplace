---
name: prd-create
description: 'Create a comprehensive PRD from scratch using BMAD methodology (12-step interactive workflow). Use when: creating a new PRD, starting product requirements, writing product requirements document from scratch.'
