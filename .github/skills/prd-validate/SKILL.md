---
name: prd-validate
description: 'Validate existing PRDs against BMAD standards (13-step comprehensive review). Use when: validating a PRD, checking PRD quality, reviewing product requirements document against standards.'
...
Read fully and follow: [step-v-01-discovery.md](./references/step-v-01-discovery.md)
