...
description: 'Analyze planning artifacts for implementation gaps — missing infrastructure, undeclared dependencies, implicit assumptions, and missing stories. Use when: analyzing gaps in epics, finding implementation gaps, checking stories for missing infrastructure, gaps analysis.'
...
Read fully and follow: [step-01-load-artifacts.md](./references/step-01-load-artifacts.md)
