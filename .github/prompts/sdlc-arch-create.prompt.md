...
3. **Load Skill**: Read `.github/skills/architecture-create/SKILL.md` and follow its instructions.

4. **Begin Workflow**: Read fully and follow `.github/skills/architecture-create/references/step-01-init.md`
