---
description: "Edit and improve an existing PRD using BMAD methodology (5-step workflow)"
agent: agent
---
...
3. **Load Skill**: Read `.github/skills/prd-edit/SKILL.md` and follow its instructions.

4. **Prompt for PRD**: "Which PRD would you like to edit? Please provide the path to the PRD.md file."

5. **Begin Workflow**: Read fully and follow `.github/skills/prd-edit/references/step-e-01-discovery.md`
