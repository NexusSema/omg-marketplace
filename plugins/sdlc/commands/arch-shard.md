...
3. **Load Skill**: Read and follow the `architecture/shard` skill instructions.

4. **Establish Step File Path**: Step files for this workflow are located at:
   `${CLAUDE_PLUGIN_ROOT}/skills/architecture/shard/references/`

5. **Begin Workflow**: Read fully and follow `${CLAUDE_PLUGIN_ROOT}/skills/architecture/shard/references/step-01-parse-source.md`
