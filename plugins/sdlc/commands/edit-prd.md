...
3. **Load Skill**: Read and follow the `edit-prd` skill instructions.
...
6. **Begin Workflow**: Read fully and follow `${CLAUDE_PLUGIN_ROOT}/skills/edit-prd/references/step-e-01-discovery.md`
