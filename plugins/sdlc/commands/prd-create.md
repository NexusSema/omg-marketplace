...
3. **Load Skill**: Read and follow the `prd/create` skill instructions.

4. **Establish Step File Path**: Step files for this workflow are located at:
   `${CLAUDE_PLUGIN_ROOT}/skills/prd/create/references/`

5. **Begin Workflow**: Read fully and follow `${CLAUDE_PLUGIN_ROOT}/skills/prd/create/references/step-01-init.md`
