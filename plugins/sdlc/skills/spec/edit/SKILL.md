...
1. Load config from `${PLUGIN_ROOT}/.claude-plugin/config.json` if it exists.
2. Route to `${PLUGIN_ROOT}/skills/spec/edit/references/step-01-load.md` to begin.

## References

Step files are located at `${PLUGIN_ROOT}/skills/spec/edit/references/`:
