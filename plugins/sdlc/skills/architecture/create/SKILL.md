...
description: "Create comprehensive architecture decisions through collaborative 8-step workflow for AI agent consistency"
...
Read fully and follow: `references/step-01-init.md`

Note: All step files are located at `${PLUGIN_ROOT}/skills/architecture/create/references/`
