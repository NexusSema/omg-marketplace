...
outputDocTemplate: 'output-doc-template.md'
contentMapFile: '{output_folder}/content-map-{source_name}.md'
gapReportFile: '{output_folder}/gap-report-{source_name}.md'
mermaidStandards: 'mermaid-diagram-standards.md'
outputDocChecklist: 'output-doc-checklist.md'
---

# Step 2: High-Level Design Architecture

**Progress: Step 2 of 8** — Next: Tech Stack & Vendor Assessment
...
Display: **High-Level Design Complete - Select an Option:** [C] Continue to Tech Stack & Vendor Assessment
