---
name: validate-prd
description: "Validate existing PRDs against BMAD standards (13-step comprehensive review)"
...
Read fully and follow: `references/step-v-01-discovery.md`

Note: All step files are located at `${PLUGIN_ROOT}/skills/validate-prd/references/`
